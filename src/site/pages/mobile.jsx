          ...
          <div className="row">
            ...
            <div className="col-lg-6">
              <div className="bloco">
                ...
                <a href="https://drive.google.com/file/d/1jQ--oS23rIcbtoVKiyXdJ5dALYW_-Ksj/view?usp=sharing" type="button" className="btn btn-success btn-lg btn-app"><i className="fa fa-android"></i> DeliveryBairro - UserApp v1.0<br/>
