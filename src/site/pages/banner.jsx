          ...
          <div className="row">
            ...
            <div className="col-lg-6">
              <div className="bloco">
                ...
                <h4>Gestão de Pedidos, Produtos, Clientes e Entregas para Bares, Restaurantes, Fast-foods e Delivery's em Geral. Tudo isso em um único lugar! Além de divulgar o seu Cardápio em nosso aplicativo Mobile (Android/iOs).</h4>
