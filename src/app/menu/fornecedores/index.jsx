...
function Index() {
    ...
    async function Editar() {
      if (nome.length === 0) {
        ...
        await api.put(`/fornecedor/update/${id_fornecedor}`, json).then(response => {
    ...
    function selectById(id){
      ...
      .then(result => {
        setIdFornecedor(result.data[0].id_fornecedor);
              ...
              props.array.map((fornecedor) => {
                return (
                  <tr key={fornecedor.id_fornecedor}>
                    ...
                    <td>
                      <Link to="#" onClick={()=>props.select(fornecedor.id_fornecedor)} title="EDITAR FORNECEDOR" data-bs-toggle="modal" data-bs-target="#md_editarfornecedor"><i className="fas fa-user-edit icon-action"></i></Link>
                      <Link to="#" onClick={()=>props.delete(fornecedor.id_fornecedor)} title="EXCLUIR FORNECEDOR"><i className="fas fa-trash-alt icon-action red"></i></Link>
                    </td>
                  </tr>
                )
              })
    ...
    return (
      <div>
        ...
        <div className="container-fluid titulo">
          ...
          <div className="row">
            ...
            <div className="col-6">
              <div className="mt-2">
                ...
                <button type="button" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#md_novofornecedor">
                  <i className="fas fa-address-book"></i> NOVO FORNECEDOR
                </button>
          ...
          <Listagem array={fornecedores} select={selectById} delete={confirmaExclusao} />
        ...
        {/* -- md_novofornecedor -- */}
        <div className="modal fade" id="md_novofornecedor" tabindex="-1" aria-labelledby="titulo_modal" aria-hidden="true">
          <div className="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div className="modal-content">

              <div className="modal-header">
                <h5 className="modal-title" id="titulo_modal">NOVO FORNECEDOR</h5>
        ...
        {/* -- md_editarfornecedor -- */}
        <div className="modal fade" id="md_editarfornecedor" tabindex="-1" aria-labelledby="titulo_modal" aria-hidden="true">
          <div className="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div className="modal-content">

              <div className="modal-header">
                <h5 className="modal-title" id="titulo_modal">EDITAR FORNECEDOR</h5>
                <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Fechar"></button>
              </div>
