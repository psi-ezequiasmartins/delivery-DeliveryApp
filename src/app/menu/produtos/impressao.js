export function imprimirListagemDeProdutos(dadosParaImpressao) {
  ...
  // Corpo da tabela
  const body = dadosParaImpressao.map((produto) => {
    return [
      { text: produto.PRODUTO_ID || '-', fontSize: 8, margin: [5, 0, 0, 0] },
